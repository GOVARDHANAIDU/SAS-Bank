...
<div class="navbar">
    ...
    <div class="form-box">
      <div class="field-group">
        ...
        <input type="text" inputmode="numeric" pattern="\d*" maxlength="19"
               oninput="formatCardNumber(this)" />
      </div>

      <div class="field-group">
        <label>Card Holder</label>
        <input type="text" oninput="updateCardName(this.value)" />
      </div>
      ...
      <div class="row">
        ...
        <div class="field-group">
          ...
          <input type="text" inputmode="numeric" maxlength="3" placeholder="123"
                 onfocus="flipCard(true)" onblur="flipCard(false)" oninput="filterCVV(this)" />
        </div>
      </div>
