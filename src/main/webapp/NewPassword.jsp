    ...
    <div class="container">
        ...
        <form action ="newpassword">
            <div class="input-group">
                <input type="password" id="newPass" name="newPassword" placeholder="New Password" required maxlength="4" class="password-field">
                <span class="glyphicon glyphicon-eye-open" onclick="togglePassword('newPass', this)" id="eye-icon"></span> 
            </div>
            <div class="input-group">
                <input type="password" id="confirmPass" name="confirmPassword" placeholder="Confirm Password" required maxlength="4" class="password-field">
